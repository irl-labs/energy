    ...
    return (
        ...
        >
            <div className="flex items-center gap-2.5 md:gap-6">
                <a href="/" className="flex items-center gap-1 text-zinc-800">
                    <Image
                        ...
                        height={36}
                    />
                    <h1 className="font-bold text-2xl hidden md:block">Energy NFT</h1>
                </a>
                <a
                    href="https://github.com/irl-labs/energy/ui"
                    target="_blank"
            ...
            <h3 className="italic text-left hidden text-zinc-500 lg:block">
                A non-custodial, permissionless Energy NFT Factory
            </h3>
